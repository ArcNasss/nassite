  ...
  return (
    <div className="bg-black text-white min-h-screen w-full flex flex-col md:flex-row items-center px-6 md:px-8 relative">
      ...
      <div className="max-w-4xl md:ml-20 gap-y-6 flex flex-col justify-center mt-16 md:mt-0">
        <p className="text-cyan-400 text-3xl mt-4 md:text-4xl italic">Hi, I'm Nasril!</p>
        <h1 className="text-5xl md:text-7xl font-extrabold text-white mt-2">Software Student</h1>
        <p className="text-gray-300 text-lg md:text-2xl leading-relaxed md:leading-8">
        ...
        <div className="flex items-center gap-4 md:gap-6 mt-6 md:mt-8 flex-wrap md:flex-nowrap">
          ...
          <div className="flex gap-4 md:hidden">
            <a href="https://github.com/ArcNasss" target="" rel="noopener noreferrer" className="hover:text-cyan-400 text-2xl">
              <FaGithub />
            </a>
            <a href="https://instagram.com/nasriillham" target="" rel="noopener noreferrer" className="hover:text-cyan-400 text-2xl">
              <FaInstagram />
            </a>
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 text-2xl">
              <FaFacebook />
            </a>
          </div>
        </div>
      ...
      <div className="hidden md:flex md:absolute md:right-32 md:bottom-48 flex-col gap-6 text-8xl mt-10 md:mt-0">
